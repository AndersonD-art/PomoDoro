...
```
git clone https://github.com/AndersonD-art/PomoDoro.git
```
---

## 📌 Casos de uso

👍 Projeto realizado utilizando como base o canal de youtube Cod3r Cursos (https://www.youtube.com/watch?v=LeRjIY4n2Vk) - https://www.cod3r.com.br/.

💬 Um PomoDoro para você gerenciar melhor o seu tempo de desenvolvimento.
...
Um super thanks 👏 para Leonardo Leitão e equipe Cod3r Cursos.
